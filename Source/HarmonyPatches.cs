...
namespace PatchedConicFixes
{
    ...
    public static class HarmonyPatches
    {
	    ...
	    /// </summary>
	    /// <param name="p">The primary orbit (vessel patch being tested). Modified in place with encounter
	    /// data if an encounter is found (UTappr, ClAppr, UTsoi, EndUT, patchEndTransition, etc).</param>
	    /// <param name="nextPatch">The orbit object to populate with the post-encounter trajectory if an
	    /// SOI transition occurs.</param>
	    ...
	    /// <param name="targetBody">The player's currently targeted body, or null. Used to compute
	    ...
	    /// <param name="UT">On entry, the initial guess for the time of closest approach.
	    /// On exit, the converged UT of the closest approach found.</param>
	    /// <param name="dT">Initial step size for the presolve phase. Typically half the
	    /// time-to-transition from the geometric intercept.</param>
